...
public class PrimeFactorizer {
	...
	public static void main(String[] args) {
		System.out.print("Prime factors of 6 are: ");
		PrimeFactorizer fac = new PrimeFactorizer(6);
		fac.generatePrimeFactors();
		System.out.println(fac.getPrimeFactors());
		
		System.out.print("Prime factors of 17 are: ");
		fac = new PrimeFactorizer(17);
		fac.generatePrimeFactors();
		System.out.println(fac.getPrimeFactors());

		System.out.print("Prime factors of 131 are: ");
		fac = new PrimeFactorizer(131);
		fac.generatePrimeFactors();
		System.out.println(fac.getPrimeFactors());
		
		System.out.print("Prime factors of 84 are: ");
		fac = new PrimeFactorizer(84);
		fac.generatePrimeFactors();
		System.out.println(fac.getPrimeFactors());
		
		System.out.print("Prime factors of 125 are: ");
		fac = new PrimeFactorizer(125);
		fac.generatePrimeFactors();
		System.out.println(fac.getPrimeFactors());
		
		System.out.print("Prime factors of 2489 are: ");
		fac = new PrimeFactorizer(2489);
		fac.generatePrimeFactors();
		System.out.println(fac.getPrimeFactors());
		
		System.out.print("Prime factors of 8633 are: ");
