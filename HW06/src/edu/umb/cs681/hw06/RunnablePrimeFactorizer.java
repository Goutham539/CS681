...
public class RunnablePrimeFactorizer extends PrimeFactorizer implements Runnable {
	...
	public static void main(String[] args) {
		...
		System.out.println("The Final result is: " + runnable.getPrimeFactors() + "\n");
		...
		threads.add(thread);
		System.out.println("Thread #" + thread.getId() + 
			" performs factorization ranges between " + runnables.get(0).getFrom() + "->" + runnables.get(0).getTo());
		
		thread = new Thread(runnables.get(1));
		threads.add(thread);
		System.out.println("Thread #" + thread.getId() + 
			" performs factorization ranges between " + runnables.get(1).getFrom() + "->" + runnables.get(1).getTo());
		...
		System.out.println("The Final result is: " + factors + "\n");
		...
		System.out.println("The Final result is: " + factors2);		
	}
}