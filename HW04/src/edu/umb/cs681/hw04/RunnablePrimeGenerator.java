...
public class RunnablePrimeGenerator extends PrimeGenerator implements Runnable {
	...
	public static void main(String[] args) {
		...
		System.out.println("Total number of prime numbers found are " + primeNum );
		System.out.println("Elapsed time for 1 thread: " + elapsed1 + " ms");
		...
		System.out.println("Elapsed time for 2 Threads: " + elapsed2 + " ms");
		...
		System.out.println("Elapsed time for 4 Threads: " + elapsedTime4 + " ms");
		...
		System.out.println("Elapsed time for 8 Threads: " + eplapsed8 + " ms");
        ...
        System.out.println("Elapsed time for 16 threads: " + elapsed16 + " ms");
	}
